...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '经典汽车宝库', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '与您一样，一个热爱汽车的人', // 作者简介
  ...
  CUSTOM_EXTERNAL_CSS: ['/custom.css'], // e.g. ['http://xx.com/style.css','http://xx.com/style.css']
